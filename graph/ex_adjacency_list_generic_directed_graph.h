...
#ifndef EX_ADJACENCY_LIST_GENERIC_DIRECTED_GRAPH_H
#define EX_ADJACENCY_LIST_GENERIC_DIRECTED_GRAPH_H
...
namespace Ex::AdjacencyList {
    ...
    void ex_adjacency_list_generic_directed_graph_test();

}

#endif //EX_ADJACENCY_LIST_GENERIC_DIRECTED_GRAPH_H
