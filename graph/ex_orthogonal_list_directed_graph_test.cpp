...
template<typename T>
void orthogonal_list_directed_graph_neighbor_test(DirectedGraph<T> &graph);

template<typename T>
void orthogonal_list_directed_graph_remove_vertex_test(DirectedGraph<T> &graph);

void orthogonal_list_directed_graph_remove_edge_test_remove_edge_test();
...
void orthogonal_list_directed_graph_unweighted() {
    ...
    orthogonal_list_directed_graph_neighbor_test(graph);
    orthogonal_list_directed_graph_remove_vertex_test(graph);
    orthogonal_list_directed_graph_remove_edge_test_remove_edge_test();
}
